 ...
 */
public class GameStateMinefieldIntro extends GameStateBase implements ITransitionListener, IWidgetListener {
    // Interface ///////////////////////////////////////////////////////////////////////////////////
    // Static --------------------------------------------------------------------------------------
    // Instance ------------------------------------------------------------------------------------
    private ConvenienceRobot robot = null;

    public GameStateMinefieldIntro(GameView.GameThread game) {
        super(game);
        ...
        infoSprite = new Sprite(res.getDrawable(R.drawable.intro_minefield, null), 0, 0, 0.0f, 0.5f);
    ...
    public void OnTransitionEnd(float value) {
        ...
        if (phase == PHASE_INTRO) {
            ...
            game.setState("GameStateMinefield");
        }
    }
