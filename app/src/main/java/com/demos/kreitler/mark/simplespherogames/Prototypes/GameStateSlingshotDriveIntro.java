 ...
 */
public class GameStateSlingshotDriveIntro extends GameStateBase implements ITransitionListener, IWidgetListener {
    // Interface ///////////////////////////////////////////////////////////////////////////////////
    // Static --------------------------------------------------------------------------------------
    // Instance ------------------------------------------------------------------------------------
    private ConvenienceRobot robot = null;

    public GameStateSlingshotDriveIntro(GameView.GameThread game) {
        super(game);
        ...
        infoSprite = new Sprite(res.getDrawable(R.drawable.intro_slingshot_drive, null), 0, 0, 0.0f, 0.5f);
    ...
    public void Draw(Canvas c) {
        ...
        switch(phase) {
            ...
            case PHASE_OUTRO: {
                int x = Math.round(c.getWidth() * transParam);
                int y = c.getHeight() / 2;
                infoSprite.setPosition(x, y);
                infoSprite.draw(c);
                break;
    ...
    public void OnTransitionEnd(float value) {
        ...
        if (phase == PHASE_INTRO) {
            ...
            game.setState("GameStateSlingshotDrive");
        }
    }
    ...
    public boolean OnWidgetTouchStart(WidgetBase widget, int localX, int localY) {
        if (widget == startAction && phase == PHASE_INPUT) {
