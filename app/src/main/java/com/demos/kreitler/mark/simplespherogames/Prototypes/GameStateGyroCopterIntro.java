 ...
 */
public class GameStateGyroCopterIntro extends GameStateBase implements ITransitionListener, IWidgetListener {
    // Interface ///////////////////////////////////////////////////////////////////////////////////
    // Static --------------------------------------------------------------------------------------
    // Instance ------------------------------------------------------------------------------------
    ...
    public GameStateGyroCopterIntro(GameView.GameThread game) {
        super(game);
        ...
        infoSprite = new Sprite(res.getDrawable(R.drawable.intro_gyro_copter, null), 0, 0, 0.0f, 0.5f);
    ...
    public void OnTransitionEnd(float value) {
        ...
        if (phase == PHASE_INTRO) {
            ...
            game.setState("GameStateGyroCopter");
        }
    }
